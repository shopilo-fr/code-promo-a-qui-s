#!/usr/bin/env python3
"""
Recuperation des codes promo A-qui-S depuis shopilo.fr
Sursa: https://shopilo.fr/reductions/a-qui-s.fr
"""
...
SHOPILO_URL = "https://shopilo.fr/reductions/a-qui-s.fr"
STORE_NAME = "A-qui-S"


def fetch_coupons(url=SHOPILO_URL):
    """Renvoie la liste des coupons actifs pour A-qui-S depuis shopilo.fr"""
    headers = {
        "User-Agent": "Mozilla/5.0 (compatible; coupon-fetcher/1.0; +https://github.com/shopilo-fr/code-promo-a-qui-s)"
    }
    try:
